...
Java_cn_co_willow_android_ultimate_gpuimage_utils_GPUImageNativeLibrary_YUVtoRBGA(JNIEnv *env,
                                                                                  jobject obj,
                                                                                  jbyteArray yuv420sp,
                                                                                  jint width,
                                                                                  jint height,
...
extern "C"
JNIEXPORT void JNICALL
Java_cn_co_willow_android_ultimate_gpuimage_utils_GPUImageNativeLibrary_YUVtoARBG(JNIEnv *env,
                                                                                  jobject obj,
                                                                                  jbyteArray yuv420sp,
                                                                                  jint width,
                                                                                  jint height,
