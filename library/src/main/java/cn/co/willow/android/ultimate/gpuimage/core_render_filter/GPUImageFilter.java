...
public class GPUImageFilter {
    ...
    public void onInit() {
        ...
        mVertexPosition = GLES20.glGetAttribLocation(mGLProgId, "vPosition");
        mVertexTexture = GLES20.glGetAttribLocation(mGLProgId, "vTextureCoord");
        mFrag2DSampler = GLES20.glGetUniformLocation(mGLProgId, "fSampler2D");
        mIsInitialized = true;
    }
    ...
    public void onDraw(final int textureId, final FloatBuffer cubeBuffer, final FloatBuffer textureBuffer) {
        ...
        GLES20.glVertexAttribPointer(mVertexPosition, 2, GLES20.GL_FLOAT, false, 0, cubeBuffer);
        GLES20.glVertexAttribPointer(mVertexTexture, 2, GLES20.GL_FLOAT, false, 0, textureBuffer);
        GLES20.glEnableVertexAttribArray(mVertexPosition);
        GLES20.glEnableVertexAttribArray(mVertexTexture);
        if (textureId != NO_TEXTURE) {
            GLES20.glActiveTexture(GLES20.GL_TEXTURE0);
            GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, textureId);
            GLES20.glUniform1i(mFrag2DSampler, 0);
        }
        onDrawArraysPre();
        GLES20.glDrawArrays(GLES20.GL_TRIANGLE_STRIP, 0, 4);
        GLES20.glDisableVertexAttribArray(mVertexPosition);
        GLES20.glDisableVertexAttribArray(mVertexTexture);
